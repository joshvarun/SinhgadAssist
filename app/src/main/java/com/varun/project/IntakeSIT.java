 ...
 */
public class IntakeSIT extends AppCompatActivity implements OnChartValueSelectedListener {

    PieChart mChart;
    Intent intent;
    String item;
    // intake of college
    private int[] yValues = {360, 240, 180, 60, 60};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intake_sit);
