 ...
 */
public class IntakeRMD extends AppCompatActivity implements OnChartValueSelectedListener {

    String item;
    Intent intent;
    PieChart mChart;
    // intake of college
    private int[] yValues = {300, 120, 60, 120, 60};
    private String[] xValues = {"Mechanical", "Civil", "E & TC", "Computer", "IT"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intake_rmd);
