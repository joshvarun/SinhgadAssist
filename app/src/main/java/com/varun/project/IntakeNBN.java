 ...
 */
public class IntakeNBN extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    // intake of college
    private int[] yValues = {180, 60, 120, 60, 60};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intake_nbn);
