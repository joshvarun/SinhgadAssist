 ...
 */
public class IntakeSAE extends AppCompatActivity implements OnChartValueSelectedListener {

    PieChart mChart;
    Intent intent;
    String item;
    // intake of college
    private int[] yValues = {240,180,180,60,120};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intake_sae);
