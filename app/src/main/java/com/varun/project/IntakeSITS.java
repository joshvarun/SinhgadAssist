 ...
 */
public class IntakeSITS extends AppCompatActivity implements OnChartValueSelectedListener {

    PieChart mChart;
    Intent intent;
    String item;
    // intake of college
    private int[] yValues = {180, 120, 120, 60, 120};
    private String[] xValues = {"Mechanical", "E & TC", "Computer",  "IT", "Civil"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intake_sits);
