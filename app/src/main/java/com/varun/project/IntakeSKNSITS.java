 ...
 */
public class IntakeSKNSITS extends AppCompatActivity implements OnChartValueSelectedListener {

    PieChart mChart;
    Intent intent;
    String item;
    // intake of college
    private int[] yValues = {180, 60, 120, 60, 120};
    private String[] xValues = {"Mechanical", "E & TC", "Computer", "IT", "Electrical"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intake_sknsits);
